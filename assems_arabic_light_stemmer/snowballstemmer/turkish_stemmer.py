...
class TurkishStemmer(BaseStemmer):
    ...
    def __r_postlude(self):
        ...
        try:
            ...
            if not self.__r_append_U_to_stems_ending_with_d_or_g():
                raise lab1()
        except lab1: pass
        self.cursor = self.limit - v_2
        # do, line 459
        ...
        try:
            ...
            if not self.__r_post_process_last_consonants():
                raise lab2()
        except lab2: pass
        self.cursor = self.limit - v_3
    ...
    def _stem(self):
        ...
        try:
            ...
            if not self.__r_stem_nominal_verb_suffixes():
                raise lab0()
        except lab0: pass
        self.cursor = self.limit - v_1
        ...
        try:
            ...
            if not self.__r_stem_noun_suffixes():
                raise lab1()
        except lab1: pass
        self.cursor = self.limit - v_2
        self.cursor = self.limit_backward
