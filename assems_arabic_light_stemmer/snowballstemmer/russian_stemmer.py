...
class RussianStemmer(BaseStemmer):
    ...
    def __r_adjective(self):
        ...
        self.ket = self.cursor
        # substring, line 88
        among_var = self.find_among_b(RussianStemmer.a_1)
        if among_var == 0:
            return False
        # ], line 88
        self.bra = self.cursor
    ...
    def __r_reflexive(self):
        ...
        self.ket = self.cursor
        # substring, line 129
        among_var = self.find_among_b(RussianStemmer.a_3)
        if among_var == 0:
            return False
        # ], line 129
        self.bra = self.cursor
    ...
    def __r_noun(self):
        ...
        self.ket = self.cursor
        # substring, line 160
        among_var = self.find_among_b(RussianStemmer.a_5)
        if among_var == 0:
            return False
        # ], line 160
        self.bra = self.cursor
    ...
    def __r_derivational(self):
        ...
        self.ket = self.cursor
        # substring, line 176
        among_var = self.find_among_b(RussianStemmer.a_6)
        if among_var == 0:
            return False
        # ], line 176
        self.bra = self.cursor
