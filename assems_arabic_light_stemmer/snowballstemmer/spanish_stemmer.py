...
class SpanishStemmer(BaseStemmer):
    ...
    def __r_standard_suffix(self):
        ...
        if among_var == 0:
            ...
            try:
                ...
                self.ket = self.cursor
                # substring, line 137
                among_var = self.find_among_b(SpanishStemmer.a_4)
                if among_var == 0:
            ...
            try:
                ...
                self.ket = self.cursor
                # substring, line 149
                among_var = self.find_among_b(SpanishStemmer.a_5)
                if among_var == 0:
    ...
    def __r_y_verb_suffix(self):
        ...
        self.ket = self.cursor
        # substring, line 168
        among_var = self.find_among_b(SpanishStemmer.a_7)
        if among_var == 0:
    ...
    def _stem(self):
        ...
        try:
            ...
            if not self.__r_attached_pronoun():
                raise lab1()
        except lab1: pass
        self.cursor = self.limit - v_2
        # do, line 219
