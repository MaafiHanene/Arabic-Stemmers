...
class PortugueseStemmer(BaseStemmer):
    ...
    def __r_standard_suffix(self):
        ...
        if among_var == 0:
            ...
            try:
                ...
                self.ket = self.cursor
                # substring, line 124
                among_var = self.find_among_b(PortugueseStemmer.a_3)
                if among_var == 0:
            ...
            try:
                ...
                self.ket = self.cursor
                # substring, line 136
                among_var = self.find_among_b(PortugueseStemmer.a_4)
                if among_var == 0:
    ...
    def __r_verb_suffix(self):
        ...
        self.ket = self.cursor
        # substring, line 160
        among_var = self.find_among_b(PortugueseStemmer.a_6)
        if among_var == 0:
    ...
    def __r_residual_suffix(self):
        ...
        self.ket = self.cursor
        # substring, line 184
        among_var = self.find_among_b(PortugueseStemmer.a_7)
        if among_var == 0:
            return False
        # ], line 184
        self.bra = self.cursor
